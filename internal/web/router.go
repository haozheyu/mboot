...
import (
	...
	"mboot/internal/command"
	"mboot/internal/config"
	"mboot/internal/dhcp"
	"mboot/internal/ipxe"
	"mboot/internal/netboot"
	"mboot/internal/netutil"
	"mboot/internal/observability"
	"mboot/internal/platform"
	"mboot/internal/storage"
	"mboot/internal/torrent"
)
...
func NewRouter(app Backend) http.Handler {
	...
	protected.GET("/ipmi/nodes", h.listIPMINodes)
	protected.POST("/ipmi/nodes", h.saveIPMINode)
	protected.PUT("/ipmi/nodes/:id", h.saveIPMINode)
	protected.DELETE("/ipmi/nodes/:id", h.deleteIPMINode)
	protected.POST("/ipmi/nodes/:id/probe", h.probeIPMINode)
